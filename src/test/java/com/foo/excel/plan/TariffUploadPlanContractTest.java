...
class TariffUploadPlanContractTest {
    ...
    void tariffApiUpload_rejectsUnknownCommonDataField() throws Exception {
        ...
        MockMultipartFile commonData = new MockMultipartFile(
                "commonData",
                "commonData",
    ...
    void persistenceHandlerContract_requiresSourceRowsAndCommonData() {
        ...
        boolean hasNewSaveAllSignature = Arrays.stream(methods)
    ...
    void tariffModule_hasTwoRepositoryBeans_forEntityAAndEntityBTransactionalPersistence() {
        long tariffRepositoryBeanCount = Arrays.stream(applicationContext.getBeanDefinitionNames())
    ...
    void tariffEntity_includesAuditColumns_withServiceDefaults() {
        ...
        List<String> actualFields = Arrays.stream(TariffExemption.class.getDeclaredFields())
                .map(Field::getName)
                .toList();
