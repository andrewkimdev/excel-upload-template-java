...
class TariffExemptionEmbeddedIdPersistenceTest {
    ...
    @Autowired
    private TariffExemptionService service;

    @Autowired
    private TariffExemptionRepository repository;

    @Autowired
    private TariffExemptionSummaryRepository summaryRepository;
    ...
    void saveAll_sameDetailId_createsThenUpdates_withFindByIdRoundTrip() {
        ...
        TariffExemptionSummaryId summaryId = new TariffExemptionSummaryId("2026", "001", "U001", "EQ-01");
    ...
    void saveAll_sameSummaryId_updatesUploadedRows() {
        ...
        service.saveAll(List.of(dto("Item1", "Model-A"), dto("Item2", "Model-B")), List.of(7, 8), commonData);
