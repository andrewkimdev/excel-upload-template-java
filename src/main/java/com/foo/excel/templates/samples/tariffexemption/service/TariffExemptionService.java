...
public class TariffExemptionService
  ...
  private boolean upsertDetailWithRetry(
      TariffExemptionDto dto, Integer rowNumber, TariffExemptionCommonData commonData) {
  ...
  private void upsertSummaryWithRetry(int rowCount, TariffExemptionCommonData commonData) {
    ...
    while (attempt <= UPSERT_RETRY_LIMIT) {
      ...
      try {
        ...
        TariffExemptionSummary newEntity =
            TariffExemptionSummary.builder().id(summaryId).uploadedRows(rowCount).build();
  ...
  private TariffExemption buildEntityFromDto(
      TariffExemptionDto dto, TariffExemptionCommonData commonData) {
    TariffExemption entity =
        TariffExemption.builder()
  ...
  private void applyAuditDefaults(
      TariffExemptionSummary entity, TariffExemptionCommonData commonData) {
    entity.setApprovedYn(commonData.getApprovedYn());
    entity.setCreatedBy(commonData.getCreatedBy());
    entity.setCreatedAt(LocalDateTime.now());
  }
