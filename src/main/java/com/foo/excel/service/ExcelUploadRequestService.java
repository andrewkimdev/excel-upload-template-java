...
public class ExcelUploadRequestService {
    ...
    public ImportResult upload(MultipartFile file, String templateType, String commonDataJson) throws IOException {
        checkFileSize(file);
    ...
    public ImportResult upload(MultipartFile file, String templateType, CommonData commonData) throws IOException {
        checkFileSize(file);
