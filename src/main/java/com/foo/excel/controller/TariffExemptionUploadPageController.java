...
public class TariffExemptionUploadPageController {
    ...
    public String upload(
            ...
            Model model) {
        try {
            TariffExemptionCommonData commonData = commonDataFormMapper.toCommonData(
                    comeYear, comeSequence, uploadSequence, equipCode);
            ImportResult result = uploadRequestService.upload(file, TemplateTypes.TARIFF_EXEMPTION, commonData);
